...
export const deContent: SiteContent = {
  locale: 'de',
  meta: {
    title: 'Drake - Framer Designer & Entwickler',
    description: 'Ich entwerfe und programmiere wunderschön einfache Dinge und ich liebe was ich tue. So einfach ist das!',
  },
  profile: {
    name: 'Drake',
    ...
    location: 'Sitz in Los Angeles, CA',
    avatarUrl: 'https://images.unsplash.com/photo-1507003211169-0a1dd7228f2d?w=400&h=400&fit=crop&crop=face',
    copyright: '© 2024 Drake. Alle Rechte vorbehalten',
  ...
  hero: {
    ...
    greeting: 'Hallo von',
    name: 'Drake',
    title: 'Framer Designer und Entwickler',
    description: 'Ich entwerfe und programmiere wunderschön einfache Dinge und ich liebe was ich tue. So einfach ist das!',
  ...
  testimonials: {
    ...
    testimonials: [
      {
        id: 'test-1',
        quote: 'Drake - Ein Entwickler mit Kreativität, Professionalität und Meisterschaft im Code. Viel mehr als erwartet. Hochwertige Produkte & flexible Preise. Empfehlenswert!',
      ...
      {
        id: 'test-2',
        quote: 'Außergewöhnliche Arbeitsqualität und tolle Kommunikation während des gesamten Projekts. Würde definitiv wieder mit Drake arbeiten!',
      ...
      {
        id: 'test-3',
        quote: 'Die Liebe zum Detail und das Designgefühl sind herausragend. Drake hat unsere Vision in Realität verwandelt.',
