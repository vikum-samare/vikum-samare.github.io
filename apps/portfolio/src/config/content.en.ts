...
export const enContent: SiteContent = {
  locale: 'en',
  meta: {
    title: 'Drake - Framer Designer & Developer',
  ...
  profile: {
    ...
    copyright: '© 2024 Drake. All Rights Reserved',
  ...
  hero: {
    ...
    greeting: 'Say Hi from',
    name: 'Drake',
    title: 'Framer Designer and Developer',
    description: 'I design and code beautifully simple things and I love what I do. Just simple like that!',
  ...
  testimonials: {
    ...
    testimonials: [
      {
        id: 'test-1',
        quote: "Drake - A Developer with the creativity, professional and master of code. Much more than what I'm expect. High quality product & flexible price. Recommended!",
      ...
      {
        id: 'test-2',
        quote: 'Exceptional work quality and great communication throughout the project. Would definitely work with Drake again!',
      ...
      {
        id: 'test-3',
        quote: 'The attention to detail and design sensibility is outstanding. Drake transformed our vision into reality.',
