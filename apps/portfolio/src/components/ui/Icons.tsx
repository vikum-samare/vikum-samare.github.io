...
export const Icons = {
  ...
  Stackoverflow: (props: IconProps) => (
    <svg {...defaultProps} {...props} viewBox="0 0 24 24">
      <path d="M18 20.5v-6h2v8H4v-8h2v6h12z" />
      <path d="M7.5 17.5h9v-2h-9v2z" />
      <path d="M7.82 14.14l8.83 1.85.41-1.96-8.83-1.85-.41 1.96z" />
      <path d="M9.24 10.09l8.17 3.81.77-1.85-8.17-3.81-.77 1.85z" />
      <path d="M11.66 6.39l6.93 5.76 1.28-1.54-6.93-5.76-1.28 1.54z" />
      <path d="M15.89 2.62l-1.64 1.23 5.38 7.16 1.64-1.23-5.38-7.16z" />
    </svg>
  ),
